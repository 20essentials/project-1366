...
export default function Page() {
  return (
    <>
      ...
      <Text className='mt-4'>
        Before using this example, you should measure which is more performant: 1.
        Directly querying your data or 2. Using a Bloom Filter to check if the
        redirect exists before querying the data.
      </Text>
      <Text className='mt-4'>
